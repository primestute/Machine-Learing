...
The dataset is imbalanced. Hence, accuracy may not be the best metric to evaluate the model performance. Therefore, we may need to look at other metrics such as precision and f1_score .
